...
T = 9; % Total number of spacecrafts in constellation
...
Duration = 30; % Modeling time in days
...
for i = 1:P
    for j = 1:T/P
            Rsat_ECI(i,j,:) = prop_simple(sat(i,j,1), sat(i,j,2), sat(i,j,3), sat(i,j,4),0);
